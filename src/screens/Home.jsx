              ...
              <div className="p-6">
                  ...
                  <div className="space-y-6 text-sm text-slate-300 leading-relaxed">
                      <section>
                          ...
                          <p>
                              Это цифровой тест Тьюринга. Среди игроков прячется <b>Нейросеть (Тост)</b>. 
                              Твоя задача — вычислить, за каким из ответов скрывается бот, 
                              и одновременно стараться запутать других. Каждый сам за себя!
                          </p>
                      </section>
